...
public class Daniel extends FullStackDeveloper {
    ...
    private final String name        = "Daniel Andrés Suárez";
    private final String education   = "Análisis y Desarrollo de Software (ADSO)";
    private final String location    = "Manizales, Colombia ☕";
    private final String[] focus     = {"Frontend Development", "Backend Architecture", "AI Automation"};
    private final String stack       = "Node.js, Angular, Java, Python, n8n, HTML/CSS";
